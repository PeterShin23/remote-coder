...
6. **Configure your projects**
   - Edit `config/projects.yaml` to map Slack channels to local paths/agents.
   - Edit `config/agents.yaml` to list agent binaries/commands (e.g., `codex-cli`) and working-directory rules.
